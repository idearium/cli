...
To publish a new version of the cli, create a new tag `vX.X.X` or `vX.X.X-beta.X` and push to GitHub. The GitHub workflow will automatically publish the new version to NPM.
